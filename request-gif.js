...
function fetchAndDisplayGif(event) {
    ...
    //console.log(document.getElementById("gif").hidden)
    
    
    
    searchQuery = document.getElementById("form-gif-request").elements[0].value;
    riddle = document.getElementById("form-gif-request").elements[1].value;
    ...
    if(riddle!=5){
        ...
        console.log("working")
        $("#riddle-error").text("No gifs for you.");
        return;
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            var jaxResponse = response.data.image_url
            var gifUrl = jaxResponse
            //console.log(gifUrl)
